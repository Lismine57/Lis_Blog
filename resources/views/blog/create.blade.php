...
<body>
    <div class="w-4/5 mx-auto">
        <div class="text-center ">
            <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-center text-gray-900">Add new post
            </h2>
            ...
            <form action="{{ route('blog.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
                ...
                <section class="bg-white">
                    <div class="py-8 lg:py-16 px-4 mx-auto ">
                            ...
                            <div>
                                <label for="excerpt"
                                    class="block mb-2 text-sm font-medium text-gray-900">Excerpt</label>
